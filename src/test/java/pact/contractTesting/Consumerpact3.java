...
public class Consumerpact3 
{
	...
	public RequestResponsePact createPact(PactDslWithProvider builder) 
	{
	    ...
	    return(builder.given("test GET")
	        ...
	        .status(200)
	        .headers(headers)
	        .body("{\"id\": \"11\", \"name\": \"kalam\", \"age\": \"78\"}")
	        .toPact());
	}
	
	//Verify correctness of contract/pact/agreement in b/w consumer_C and provider microservice
	@Test
	@PactVerification
